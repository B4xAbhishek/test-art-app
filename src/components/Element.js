export const createElement = (id, x1, y1, x2, y2, type, color = "#000000") => {
  switch (type) {
    case "line":
      return {id, x1, y1, x2, y2, type, color}
    case "rectangle":
      return { id, x1, y1, x2, y2, type, color };
    case "circle":
      return { x1, y1, x2, y2, type, id, color }
    case "pencil":
      return { id, type, points: [{ x: x1, y: y1 }], paths: [], color };
    case "text":
